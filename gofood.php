...
function register_gojek() {
   ...
   if (stripos($register, '"success":true')) {
    ...
    if (stripos($verify, '"access_token"')) {
        ...
        $claim = curl('https://api.gojekapi.com/go-promotions/v1/promotions/enrollments', '{"promo_code":"EATLAH"}', headers($access_token));
        ...
        echo "[+] Mencoba Redem Voucher EATLAH\n";
        ...
        echo "\n";
        sleep(9);
        $claim2 = curl('https://api.gojekapi.com/go-promotions/v1/promotions/enrollments', '{"promo_code":"PAKEGOFOOD0906"}', headers($access_token));
        echo "[+] Mencoba Redem Voucher PAKEGOFOOD0906\n";
...
echo "Gojexnxx Tools - Gojek Register + Claim GoFood\n";
register_gojek();
